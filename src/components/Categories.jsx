      ...
      <div className="mt-10 flex flex-col items-center">
        <div className="grid grid-cols-3">
          <div className="text-center">
            ...
            <p className="text-white text-[1.5rem] font-semibold">Standup Comedy</p>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-white text-[1.5rem] font-semibold">Talk Shows</p>
          </div>
        </div>
        <div className="grid grid-cols-3 mt-10">
          <div className="text-center">
            <img src={sing} alt="sing" />
            <p className="text-white text-[1.5rem] font-semibold">Live Singing</p>
          </div>
          <div className="text-center">
            <img src={ted} alt="tedp" />
            <p className="text-white text-[1.5rem] font-semibold">TED Talks</p>
          </div>
          <div className="text-center">
            <img src={poem} alt="poem" />
            <p className="text-white text-[1.5rem] font-semibold">Live Poetry</p>
          </div>
        </div>
      </div>
      <div className="mt-8 w-full flex justify-center">
        <button className="bg-black border border-[#3D37F1] text-[#3D37F1] px-10 py-4 rounded-[30px] mb-10">Load More</button>
      </div>
    </div>
  );
};
